...
void particle::onenter(float x, float y)
{
    emitter = nullptr;
}

void particleBegain::onenter(float x, float y)
{
...
void particleExplosion::onenter(float x, float y)
{
...
void particleFire::onenter(float x, float y)
{
...
void particleMetorRain::onenter(float x, float y)
{
...
void particleNormalAttack::onenter(float x, float y)
{
...
void particleSend::onenter(float x, float y)
{
    auto emitter = ParticleSystemQuad::create("Send.plist");
    if (emitter) {
        // 创建批处理节点并使用粒子纹理来初始化
